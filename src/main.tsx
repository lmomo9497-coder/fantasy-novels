...
type AccountSection = "favorites" | "history" | "notifications" | null;
...
function App() {
  ...
  async function loadAccountData() {
    ...
    if (favoritesResult.error) {
      console.error("Favorites:", favoritesResult.error);
    } else {
      setFavorites(favoritesResult.data || []);
    }

    if (historyResult.error) {
      console.error("History:", historyResult.error);
    } else {
            ...
            <div className="account-card">
                        ...
                        >
                          <div>
                            ...
                            {notification.chapters ? (
                              <small>
                                الفصل:{" "}
                                {notification.chapters.chapter_number}
              ...
              <div className="account-section">
                ...
                <div className="panel account-role">
                  <strong>قارئ</strong>
                  <span>
                    حساب قراءة عادي، بدون صلاحيات الإدارة.
                  </span>
                </div>
              </div>
